...
func init() {
	...
	attackFrames[0][action.ActionDeerCharge] = 17
	attackFrames[0][action.ActionSkill] = 14
	attackFrames[0][action.ActionBurst] = 14
	attackFrames[0][action.ActionDash] = 14
	attackFrames[0][action.ActionJump] = 14
	attackFrames[0][action.ActionSwap] = 14
	...
	attackFrames[0][action.ActionDeerCharge] = 19
	attackFrames[1][action.ActionSkill] = 11
	attackFrames[1][action.ActionBurst] = 11
	attackFrames[1][action.ActionDash] = 11
	attackFrames[1][action.ActionJump] = 11
	attackFrames[1][action.ActionSwap] = 11

	attackFrames[2] = frames.InitNormalCancelSlice(attackHitmarks[2], 33) // N3 -> CA
	attackFrames[2][action.ActionAttack] = 38
	attackFrames[0][action.ActionDeerCharge] = 33
	attackFrames[2][action.ActionSkill] = 16
	attackFrames[2][action.ActionBurst] = 16
	attackFrames[2][action.ActionDash] = 16
	attackFrames[2][action.ActionJump] = 16
	attackFrames[2][action.ActionWalk] = 38
	attackFrames[2][action.ActionSwap] = 16
}
